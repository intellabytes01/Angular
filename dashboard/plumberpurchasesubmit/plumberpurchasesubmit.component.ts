...
@Component({
  selector: 'app-plumberpurchasesubmit',
  templateUrl: './plumberpurchasesubmit.component.html',
  styleUrls: ['./plumberpurchasesubmit.component.scss']
})
export class PlumberpurchasesubmitComponent implements OnInit {
  ...
  message:string;
    ...
    viewPerson(event,person,whatreport){
      console.log(event.target.text,person,whatreport);
        ...
        this.router.navigate(['dashboard/purchasesubmit'],{queryParams:{prvr:this.prevParams1.prvr,ltst:event.target.text}});
