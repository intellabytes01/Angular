...
@Component({
  selector: 'app-purchase-submit',
  templateUrl: './purchase-submit.component.html',
  styleUrls: ['./purchase-submit.component.scss']
})
export class PurchaseSubmitComponent implements OnInit {
  ...
  behalfee:String;
    ...
    ngOnInit() {
        ...
        if(this.param.prvd && this.param.prvd!=this.param.ltst){
          //console.log("this is distributer");
