...
@Component({
  selector: 'app-retalerpurchasesubmit',
  templateUrl: './retalerpurchasesubmit.component.html',
  styleUrls: ['./retalerpurchasesubmit.component.scss']
})
export class RetalerpurchasesubmitComponent implements OnInit {
  ...
  message:string;
    ...
    viewPerson(event,person,whatreport){
      console.log(event.target.text,person,whatreport);
        ...
        this.router.navigate(['dashboard/purchasesubmit'],{queryParams:{prvd:this.prevParams1.prvd,ltst:event.target.text}});
