...
@Component({
  selector: 'app-distributer-manage-user',
  templateUrl: './distributer-manage-user.component.html',
  styleUrls: ['./distributer-manage-user.component.scss']
})
export class DistributerManageUserComponent implements OnInit {
